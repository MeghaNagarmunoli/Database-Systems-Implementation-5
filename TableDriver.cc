...
bool TableDriver::createTable() { // CREATE TABLE
...
bool TableDriver::dropTable() { // DROP TABLE
  // delete from catalog
...
bool TableDriver::exists(const char* relName) {
  ifstream fin (catalog_path);
  string line;
  while (getline(fin, line))
