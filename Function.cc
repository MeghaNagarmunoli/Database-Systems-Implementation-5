...
void Function :: PrintToStream (std::ostream &os, Schema *schema) {
	if(numOps > 0 ) {
		os << "Function: ";
	}
	...
	for(int i=0;i<numOps;i++){
		...
		switch(currOpList[i].myOp){
			case 0:
				optn="PushInt";
				os << "Operand Type: " << optn << "\n";
				os << "Attribute : "<< attrs[currOpList[i].recInput].name << "\n";
				break;
			case 1:
				optn="PushDouble";
				os << "Operand Type: " << optn << "\n";
